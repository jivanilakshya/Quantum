...
MODEL_TYPE = os.getenv('MODEL_TYPE', 'modern')  # Options: modern, regularized, original, transfer, keras
MODEL_TYPE_PROD = os.getenv('MODEL_TYPE_PROD', 'keras')  # Model type for production/inference
MODEL_PATH = os.getenv('MODEL_PATH', os.path.join(BASE_DIR, 'model.h5'))  # Default to external model.h5
